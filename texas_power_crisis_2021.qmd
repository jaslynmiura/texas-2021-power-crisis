...
# plotting
plot(lights_07_houston,
     main = "VIIRS displaying light intensity on 02-07-2021",
     axes = TRUE,
     key.pos = NULL)
plot(lights_16_houston,
     main = "VIIRS displaying light intensity on 02-16-2021",
     axes = TRUE)
...
# ADD A BASE MAP OF HOUSTON
tm_shape(outside_roads_houses, bbox = houston_bbox) +
  tm_polygons()  + 
  tm_title(text = "Houses")
...
census_no_blackout_clip <- st_difference(outside_roads_houses, ACS_crop)
...
tm_shape(census_no_blackout_clip) +
  tm_polygons() +
  tm_shape(outside_roads_houses) +
  tm_polygons(fill = "hotpink")
