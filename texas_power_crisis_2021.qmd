...
```{r}
# check what the crs of masked_sf is 
st_crs(masked_sf)

houston_bbox <- st_bbox(c(xmin = -94.5, ymin = -29, xmax = -96.5, ymax = 30.5),
        crs = st_crs(4326))

houston_sf <- st_crop(masked_sf, houston_bbox)
...
houston_transformed <- st_transform(houston_sf, crs = st_crs(3083))
